...
class Feeder(Dataset):
    def __init__(self, data_path, split='train', window_size=-1, debug=False, use_mmap=True):
        ...
        self.load_data() #load data 创建data对象
        ...
        if vid is not None:
            ...
            if graph is None:
                ...
                for t in range(T):
                    ...
                    ax.text2D(0.05, 0.95, label_text, transform=ax.transAxes, fontsize=12, color='red',
...
if __name__ == '__main__':
    ...
    f.show(vid=200,                      # args needed to specify
        graph=graph, 
        is_3d=True,
        save_path='./h2o/h2o_sample_6'  # args needed to specify
    )