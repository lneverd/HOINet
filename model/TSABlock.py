...
class TSABlock(nn.Module):
    def __init__(self, in_channels, out_channels, qkv_dim,
        ...
        self.M = nn.Parameter(torch.ones(1, num_heads, num_tokens, num_tokens) / num_tokens, requires_grad=True)#形状与attn一样的全1的可调节矩阵
    ...
    def forward(self, x):
        ...
        N, C, T, JE, TokenNum = x.size() #1 3 20 3 126
