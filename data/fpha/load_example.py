...
if __name__ == '__main__':
    ...
    parser.add_argument(
        '--obj', required=False, default=None,choices=['liquid_soap', 'juice', 'milk', 'salt'])
    ...
    if args.obj is not None:
        ax.scatter(verts_proj[:, 0], verts_proj[:, 1], alpha=0.01, c='#00F5FF')
    ax.axis('off')
    output_path = os.path.join('./', 'output',
                               f"{args.subject}_{args.action_name}_{args.seq_idx}_frame{args.frame_idx:04d}.png")
